      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="mt-6 flex flex-wrap justify-center gap-3">
            <a
              href="https://apps.apple.com/in/app/fixmycardude/id6753746634"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Download FixMyCarDude on the App Store"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#00594F] text-white rounded-xl hover:bg-[#003d35] transition-colors hover:shadow-lg hover:shadow-[#00594F]/20"
            >
            ...
            <a
              href="https://play.google.com/store/apps/details?id=com.fixmycardude"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Get FixMyCarDude on Google Play"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-white border border-[#00594F]/15 text-[#00594F] rounded-xl hover:bg-[#00594F]/5 transition-colors"
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
